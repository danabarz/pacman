...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        self.qValues = dict()  # An item will look like: self.qValues[state] -> state:{action1:qValue1 , action2:qValue2, ...}
    ...
    def update(self, state, action, nextState, reward):
        ...
        # compute the updated q_val (as seen in the lecture)
        updated_q_value = (1 - self.alpha) * current_q_value + self.alpha * (reward + self.discount * next_value)
